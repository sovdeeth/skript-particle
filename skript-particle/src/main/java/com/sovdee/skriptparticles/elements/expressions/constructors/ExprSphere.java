...
@Since("1.0.0")
public class ExprSphere extends SimpleExpression<Shape> {

    static {
        Skript.registerExpression(ExprSphere.class, Shape.class, ExpressionType.COMBINED, "[a] [:solid] sphere (with|of) radius %number%");
    }
