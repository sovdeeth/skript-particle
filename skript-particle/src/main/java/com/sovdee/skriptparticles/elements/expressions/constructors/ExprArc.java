...
public class ExprArc extends SimpleExpression<Shape> {
    ...
    static {
        Skript.registerExpression(ExprArc.class, Shape.class, ExpressionType.COMBINED,
    ...
    protected Shape[] get(Event event) {
        ...
        DrawableShape shape = new DrawableShape(new com.sovdee.shapes.Arc(radius.doubleValue(), height.doubleValue(), angle.doubleValue()));
        if (isSector)
