 ...
 * When used inside a {@link DrawShapeEffectSection.DrawEvent DrawEvent}
...
public class EffRotateShape extends Effect {
    ...
    public static void register(SyntaxRegistry registry) {
        registry.register(SyntaxRegistry.EFFECT, SyntaxInfo.builder(EffRotateShape.class)
                .supplier(EffRotateShape::new)
                .addPatterns(
    ...
    public String toString(@Nullable Event event, boolean debug) {
        if (rotation != null)
            return "rotate shape " + (useDrawnShapes ? "drawn shapes" : shapes.toString(event, debug)) + " by " + rotation.toString(event, debug);
        return "rotate shape " + (useDrawnShapes ? "drawn shapes" : shapes.toString(event, debug)) + " around " + (relative ? "relative " : "") +
