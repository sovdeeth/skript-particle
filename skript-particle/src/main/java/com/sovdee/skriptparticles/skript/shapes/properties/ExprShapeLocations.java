...
public class ExprShapeLocations extends SimpleExpression<Location> {
    ...
    public static void register(SyntaxRegistry registry) {
        registry.register(SyntaxRegistry.EXPRESSION, SyntaxInfo.Expression.builder(ExprShapeLocations.class, Location.class)
                .supplier(ExprShapeLocations::new)
                .addPatterns("(particle|point) locations of %shapes% [[centered] %direction% %location%]")
                .build());
    }
