...
import com.sovdee.skriptparticles.rendering.DrawManager;
...
public abstract class DrawShapeEffectSection extends EffectSection {
    ...
    @Override
    public boolean init(
            Expression<?>[] expressions, int matchedPattern, Kleenean isDelayed, ParseResult parseResult,
    ...
    protected TriggerItem walk(Event event) {
        ...
        // set up consumer to do the pre-drawing execution
        ...
        // determine locations to draw at
        ...
        // async drawing runs all the code sync prior to dispatching the drawing thread
        if (sync) {
