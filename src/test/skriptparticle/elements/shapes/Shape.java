...
public abstract class Shape implements Cloneable {
    ...
    private Shape.Style previousStyle;
    ...
    public void
    draw(Location location, Vector position) {
        draw(location, Quaternion.IDENTITY, particle);
    }

    public void draw(Location location, Vector position, Quaternion orientation) {
        draw(location, orientation, particle);
    }

    public void draw(Location location, Vector position, ParticleBuilder particle) {
        draw(location, Quaternion.IDENTITY, particle);
    }

    public void draw(Location location, Quaternion parentOrientation, Particle particle) {
        ...
        for (Vector point : points) {
            Vector motion = particle.getMotion().getVector(point);
//            particle.location().add(point);
//            particle.spawn();
        }
    }
    ...
    public Shape style(Shape.Style style) {
        this.style = style;
        return this;
    }
