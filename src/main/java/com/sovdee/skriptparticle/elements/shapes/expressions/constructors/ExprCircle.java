...
public class ExprCircle extends SimpleExpression<Circle> {
    ...
    static {
        Skript.registerExpression(ExprCircle.class, Circle.class, ExpressionType.COMBINED, "[a] circle [with|of] radius %number%");
    }
    ...
    protected Circle[] get(Event event) {
        ...
        return new Circle[]{new Circle(r.doubleValue())};
    }
